...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hash', models.CharField(help_text='The hash of the hoc file', max_length=1000, unique=True)),
                ('name', models.CharField(help_text='The name of the hoc environment', max_length=1000)),
                ('store', models.ForeignKey(blank=True, help_text='The store of the file', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.bigfilestore')),
            ],
        ),
        migrations.CreateModel(
