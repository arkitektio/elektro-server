# Generated by Django 4.2.8 on 2025-04-23 15:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hash",
                    models.CharField(
                        help_text="The hash of the model", max_length=1000, unique=True
                    ),
                ),
                (
                    "json_model",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration",
                    models.FloatField(help_text="The duration of the run in seconds"),
                ),
                (
                    "dt",
                    models.FloatField(
                        default=1.0, help_text="The time step of the run in seconds"
                    ),
                ),
                (
                    "name",
                    models.CharField(help_text="The name of the run", max_length=1000),
                ),
                (
                    "model",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        choices=[
                            ("TIME", "Mask (Value represent Labels)"),
                            ("VOLTAGE", "Voltage (Value represent Intensity)"),
                            ("CURRENT", "Current (Value represent Intensity)"),
                            ("UNKNOWN", "Unknown"),
                        ],
                        choices_enum=core.enums.TraceKindChoices,
                        default="UNKNOWN",
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        ...
                        choices_enum=core.enums.StimulusKindChoices,
                        default="CURRENT",
                ...
                (
                    "cell",
                    models.CharField(
                        help_text="The cell thsat was ssrecorded", max_length=1000
                    ),
                ),
                (
                    "location",
                    models.CharField(
                        help_text="The location of the recording", max_length=1000
                    ),
                ),
                (
                    "position",
                    models.CharField(
                        help_text="The position of the recording", max_length=1000
                    ),
                ),
                (
                    "label",
                    models.CharField(
                        help_text="The label of the recording", max_length=1000
                    ),
                ),
                (
                    "simulation",
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        ...
                        choices_enum=core.enums.RecodingKindChoices,
                        default="VOLTAGE",
                        help_text="The Representation can have vasrying kind, consult your API",
                        max_length=7,
                    ),
                ...
                (
                    "cell",
                    models.CharField(
                        help_text="The cell of the recording", max_length=1000
                    ),
                ),
                (
                    "location",
