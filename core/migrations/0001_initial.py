    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_start', models.FloatField(default=0.0, help_text='The start time of the signal in seconds')),
                ('description', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('membership', models.ForeignKey(blank=True, db_constraint=False, help_text='The organization that owns the dataset', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentikate.membership')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1000, null=True)),
                ('parameter_ports', models.JSONField(default=dict, help_text='The parameter ports of the mechanism, stored as a json object with the port name as key and the port type as value')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('organization', models.ForeignKey(help_text='The organization that owns the mechanism', on_delete=django.db.models.deletion.CASCADE, related_name='mechanisms', to='authentikate.organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mechanism', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='model_mappings', to='core.mechanism')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='environment_mappings', to='core.neuronmodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(blank=True, help_text='The store of the trace', null=True, on_delete=django.db.models.deletion.CASCADE, to='datalayer.zarrstore')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='The name of the signal', max_length=1000)),
                ('pinned_by', models.ManyToManyField(blank=True, help_text='The users that pinned this segment', related_name='pinned_irregularly_sampled_signals', to=settings.AUTH_USER_MODEL)),
                ('recording_segment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='irregularly_sampled_signals', to='core.blocksegment')),
                ('time_trace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='irregularly_sampled_time_signals', to='core.trace')),
                ('trace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='irregularly_sampled_trace_signals', to='core.trace')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('organization', models.ForeignKey(blank=True, db_constraint=False, help_text='The organization that owns the dataset', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentikate.organization')),
                ('store', models.ForeignKey(blank=True, db_constraint=False, help_text='The store of the trace', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='datalayer.zarrstore')),
