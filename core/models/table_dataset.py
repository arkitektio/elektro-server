...
class Column(models.Model):
    ...
    # elektro: mikro's `node_references` (a NetworkCollection's node ids) is gone -- this service
    # has no network collections, so there is nothing a column could key by node.
