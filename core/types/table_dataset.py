...
**Vendored from mikro** (``mikro/core/types/table_dataset.py``). elektro: tenant-scoped like
every type here, and ``Column.nodeReferences`` is gone with the network collections.
"""
...
class Column(OrgScopedOrNested):
