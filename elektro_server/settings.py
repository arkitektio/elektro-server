...
# Semantic search (the vendored ``embeddings`` package). Array, table and sparse datasets
# embed their name + description into a pgvector column on save, with a model2vec static
